...
def main():
    ...
    print("The total molar mass of the formula is: ", total_molar_mass)
...
def main():
    ...
    sample_mass_grams = float(input("Enter the mass of the chemical sample in grams: "))
    ...
    moles = sample_mass_grams / molar_mass

    # Print the molar mass.
    print("The molar mass of the formula is: ", molar_mass)

    # Print the number of moles.
    print("The number of moles in the sample is: ", moles)
